...
func (siw *ServerInterfaceWrapper) DeletePet(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "petId", chi.URLParam(r, "petId"), &petId, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "integer", Format: "int64"})
	if err != nil {
...
func (response CreatePet201Response) VisitCreatePetResponse(w http.ResponseWriter) error {
	w.WriteHeader(201)
	return nil
}
...
func (response GetPetById200Response) VisitGetPetByIdResponse(w http.ResponseWriter) error {
	w.WriteHeader(200)
	return nil
}
