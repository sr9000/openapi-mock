...
const file_echo_api_proto_rawDesc = "" +
	"\n" +
	"\x0eecho/api.proto\"'\n" +
	...
	"\vEchoService\x12#\n" +
	"\x04Echo\x12\f.EchoRequest\x1a\r.EchoResponseB'Z%grpc-mock/internal/genproto/echo;echob\x06proto3"

var (
	file_echo_api_proto_rawDescOnce sync.Once
	file_echo_api_proto_rawDescData []byte
)

func file_echo_api_proto_rawDescGZIP() []byte {
	file_echo_api_proto_rawDescOnce.Do(func() {
		file_echo_api_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_echo_api_proto_rawDesc), len(file_echo_api_proto_rawDesc)))
	})
	return file_echo_api_proto_rawDescData
}

var file_echo_api_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_echo_api_proto_goTypes = []any{
...
func file_echo_api_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_echo_api_proto_rawDesc), len(file_echo_api_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
